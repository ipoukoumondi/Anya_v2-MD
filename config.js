...
module.exports = {
     ...
     */
    botname: process.env.BotName || "dark joker",
     ...
     */
    ownername: process.env.Owner_Name || "dark joker",
    ownernumber: process.env.Owner_Number || "242066328691",
    instagramId: process.env.Insta || "dark joker",
